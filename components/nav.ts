...
export const sections: NavSection[] = [
  ...
  { id: 'recruiting', label: 'College Recruiting', short: 'Recruiting', icon: '🎓' },
  { id: 'near', label: 'Clubs Near You', short: 'Near You', icon: '📍' },
  { id: 'futsal', label: 'Futsal & Indoor', short: 'Futsal', icon: '🥅' },
  { id: 'calendar', label: 'Showcase Calendar', short: 'Calendar', icon: '🗓️' },
