...
export const girlsClubs: GirlsClub[] = [
  ...
  { name: 'Revolution FC (East County)', league: 'ECRL Girls' },
...
export const girlsDirectoryClubs: GirlsDirClub[] = [
  ...
  { name: 'Revolution FC (East County)', city: 'Brentwood', region: 'East Bay', level: 'ECRL Girls', website: 'https://www.revolutionfc.org/' },
  { name: 'Association FC', city: 'Castro Valley', region: 'East Bay', level: 'ECRL Girls', website: 'https://www.associationfc.org/' },
  ...
  { name: 'Valley Surf', city: 'Lathrop / Manteca', region: 'Central Valley', level: 'ECRL Girls', website: 'https://www.valleysurf.org/' },
];
